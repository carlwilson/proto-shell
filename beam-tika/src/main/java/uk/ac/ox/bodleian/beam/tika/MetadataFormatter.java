...
public final class MetadataFormatter {
	...
	/**
	 * @return the static formatter instance
	 */
	...
	/**
	 * @param metadata the metadata to covert to JSON
	...
	/**
	 * @param metadata the metadata to convert to XML
	 * @return an XML representation of the metadata object
	 */
	...
	/**
	 * @param mediaType the MediaType to convert to XML
	 * @return the XML representation of the MediaType
	 */
	...
	/**
	 * @param parameters the parameters to convert to XML
	 * @return an XML representation of the parameters
	 */
	...
	/**
	 * @param mediaType the MediaType to convert to JSON
	 * @return the JSON representation of the MediaType
	 */
	...
	/**
	 * @param parameters the parameters to convert to JSON
