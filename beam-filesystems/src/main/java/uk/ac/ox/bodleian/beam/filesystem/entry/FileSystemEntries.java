...
public final class FileSystemEntries {
	 ...
	 * @return a final unchecked Entry populated from the file
	 */
	...
	/**
	 * @param archEntry
	 * @return a new Entry created from the tar entry and it's stream
	 */
	public static final FileSystemEntry fromArchive(final ArchiveEntry archEntry) {
		if (archEntry == null) throw new IllegalArgumentException("tarEntry == null");
		if (archEntry.getName() == null) throw new IllegalArgumentException("tarEntry.getName() == null");
		if (archEntry.getName().isEmpty()) throw new IllegalArgumentException("tarEntry.getName().isEmpty() == true");
		
		return FileSystemEntryImpl.fromValues(archEntry.getName(), archEntry.getSize(), archEntry.getLastModifiedDate().getTime());
	}
}
