...
/**
 * Encapsulates some basic, universal properties of a Entry. The
 ...
 * <li>The name of the Entry, often a relative path, e.g. a zip entry
 * name.</li>
...
public interface FileSystemEntry {
	...
	/**
	 * @return the modified date in miiliseconds
	 */
